...
BEGIN
	...
	prt_valor='emt_supervielle_desa_prueba',
	prt_baja_fecha=null
...
BEGIN
	...
	INSERT INTO wf_parametros VALUES (@prt_id,'Base Depuración','BaseDepur','Depuracion','emt_supervielle_desa_prueba','S','N','Base Depuración','','20190711',null,null,1,'')
...
BEGIN
	...
	INSERT INTO wf_parametros values (@prt_id,'Bitácora obj-Cant. de Dias a depurar','CboDias','Depuracion','90','S','N','Pase a Historico','','20190711',null,null,1,'')
...
BEGIN
	...
	INSERT INTO wf_parametros values (@prt_id,'Bitacora saldos-Cant. de Dias a depurar','CsaCant','Depuracion','1','S','N','Pase a Historico','','20190711',null,null,1,'')
...
BEGIN
	...
	INSERT INTO wf_parametros values (@prt_id,'Bitacora de cuentas-Cant. Reg. p/Transaccion','CctCommit','Depuracion','5000','S','N','Pase a Historico','','20190711',null,null,1,'')
...
BEGIN
	...
	INSERT INTO wf_parametros values (@prt_id,'Bitacora de cta-Cant. de Dias a depurar','CctDias','Depuracion','365','S','N','Pase a Historico','','20190711',null,null,1,'')
...
BEGIN
	...
	INSERT INTO wf_parametros values (@prt_id,'Bitacora per_tel-Cant. Dias a depurar','CtfDias','Depuracion','90','S','N','Pase a Historico','','20190711',null,null,1,'')
